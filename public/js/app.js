...
!function (a) {
  "use strict";
  var b = { initialised: !1, version: 1.4, mobile: !1, menuCollapse: !1, isFirefox: navigator.userAgent.toLowerCase().indexOf("firefox") > -1, navContainerHeight: null, container: a(".portfolio-item-container"), init: function init() {
      if (!this.initialised) {
        this.initialised = !0, this.checkMobile(), this.checkPlaceholder(), this.getNavContainerHeight(), this.menuHover(), this.responsiveMenu(), this.itemHoverAnimation(), this.searchInput(), this.itemSizeFix(), this.filterColorBg(), this.productZoomImage(), this.responsiveVideo(), this.priceSlider(), this.ratings(), this.collapseArrows(), this.owlCarousels(), this.flexsliders(), this.scrollTopAnimation(), this.filterScrollBar(), this.selectBox(), this.bootstrapSwitch(), this.tooltip(), this.popover(), this.progressBars(), this.prettyPhoto(), this.flickerFeed(), this.parallax(), this.twitterFeed();var a = this;"function" == typeof imagesLoaded && imagesLoaded(a.container, function () {
      ...
      a.support.placeholder = function () {
        var a = document.createElement("input");return "placeholder" in a;
      }(), !a.support.placeholder && a.fn.placeholder && a("input, textarea").placeholder();
    }, firefoxMenuFix: function firefoxMenuFix() {
      var b = (a(window).width(), a("#header")),
          c = b.hasClass("header6") || b.hasClass("header7"),
          d = a(".menu");if (c && this.isFirefox) {
        var e = d.children("li");e.each(function () {
          var b = a(this),
              c = b.children("ul"),
              d = b.position().left;c.length && c.css("left", d);
        });
      }
    }, getNavContainerHeight: function getNavContainerHeight() {
      a(window).width() > 768 && (this.navContainerHeight = a("#main-nav-container").outerHeight());
    }, fixNavContainerHeight: function fixNavContainerHeight() {
      ...
      var b = this,
          ...
          h = e.height() - b.navContainerHeight;c >= g && c > h && d > 768 ? (f.closest(".fixed-wrapper").length || f.wrap(function () {
        return '<div class="fixed-wrapper" style="height:' + b.navContainerHeight + 'px"></div>';
      }), f.addClass("fixed")) : f.removeClass("fixed");
    }, menuHover: function menuHover() {
      a.fn.hoverIntent && a("ul.menu").hoverIntent({ over: function over() {
      ...
      var b = a(".menu").clone(!0).removeClass("menu").addClass("responsive-nav"),
          c = a("#responsive-nav");c.append(b), c.find("li, .col-2, .col-3, .col-4, .col-5").each(function () {
        var b = a(this);b.hasClass("mega-menu-container") && b.removeClass("mega-menu-container"), b.has("ul, .megamenu").prepend('<span class="menu-button"></span>');
      }), a("span.menu-button").on("click", function () {
        var b = a(this);b.hasClass("active") ? a(this).removeClass("active").siblings("ul, .mega-menu").slideUp("800") : a(this).addClass("active").siblings("ul, .mega-menu").slideDown("800");
      }), a("#responsive-nav-button").on("click", function () {
        var b = a(this);b.hasClass("active") ? a("#responsive-nav").find(".responsive-nav").slideUp(300, function () {
          b.removeClass("active");
        }) : a("#responsive-nav").find(".responsive-nav").slideDown(300, function () {
          b.addClass("active");
        });
      });
    }, itemAnimationIn: function itemAnimationIn() {
      var b = a(this),
          c = b.find(".icon-cart-text"),
          d = b.width(),
          e = b.find(".ratings-amount"),
          f = b.find(".item-action-inner");220 > d && c.animate({ width: "hide" }, 100, function () {
        a(this).closest(".item-add-btn").addClass("icon-cart");
      }), e.animate({ width: "show" }, 300), f.css({ visibility: "visible", overflow: "hidden", "padding-left": 10 }).animate({ width: 85 }, 300);
    }, itemAnimationOut: function itemAnimationOut() {
      var b = a(this),
          c = b.find(".icon-cart-text"),
          d = b.width(),
          e = b.find(".ratings-amount"),
          f = b.find(".item-action-inner");220 > d && c.animate({ width: "show" }, 300).closest(".item-add-btn").removeClass("icon-cart"), e.animate({ width: "hide" }, 300), f.animate({ width: 0 }, 300, function () {
        a(this).css("padding-left", 0);
      }).css({ visibility: "hidden", overflow: "hidden" });
    }, itemHoverAnimation: function itemHoverAnimation() {
      var b = this;a.fn.hoverIntent ? a(".item-hover").hoverIntent(b.itemAnimationIn, b.itemAnimationOut) : a(".item-hover").on("mouseover", b.itemAnimationIn).on("mouseleave", b.itemAnimationOut);
    }, itemSizeFix: function itemSizeFix() {
      var b = a("#content"),
          c = b.find(".item");c.each(function () {
        var b = a(this);b.hasClass("item-hover") || b.closest(".carousel-inner").length || (b.width() < 220 ? (b.find(".icon-cart-text").fadeOut(20, function () {
          a(this).closest(".item-add-btn").addClass("icon-cart");
        }), b.find(".ratings-container.pull-right, .item-price-container.pull-left").css({ "float": "none", display: "block", width: "100%" }), b.find(".item-price-container.pull-left").css("margin-bottom", 10), b.find(".item-action").css("text-align", "center")) : (b.find(".icon-cart-text").fadeIn(10).closest(".item-add-btn").removeClass("icon-cart"), b.find(".ratings-container.pull-right").css({ "float": "right", width: "auto" }), b.find(".item-price-container.pull-left").css({ "float": "left", width: "auto", "margin-bottom": 0 }), b.find(".item-action").css("text-align", "left")));
      });
    }, searchInput: function searchInput() {
      var b = !0;a("#quick-search").on("click", function (c) {
        var d = a(this),
            e = d.closest(".quick-search-form"),
            f = e.find(".form-control"),
            g = a.trim(f.val());if ("" === g) {
          var h = e.find(":hidden.form-group"),
              i = e.find(".form-group ");b ? h.animate({ width: "show" }, 400, function () {
            b = !1;
          }) : i.animate({ width: "hide" }, 400, function () {
            b = !0;
          }), c.preventDefault();
        }
      });
    }, filterColorBg: function filterColorBg() {
      a(".filter-color-box").each(function () {
        var b = a(this),
            c = b.data("bgcolor");b.css("background-color", c);
      });
    }, twitterFeed: function twitterFeed() {
      a.fn.tweet && a(".twitter_feed").length && (a(".twitter_feed").tweet({ modpath: "./js/twitter/", avatar_size: "", count: 4, query: "themeforest", loading_text: "searching twitter...", join_text: "", template: "{join}{text}{time}" }), a(".twitter_feed.flexslider").flexslider({ animation: "slide", selector: ".tweet_list > li", controlNav: !1, prevText: "", nextText: "", animationLoop: !0, smoothHeight: !0, slideshowSpeed: 5e3 })), a.fn.tweet && a(".twitter_feed_widget").length && a(".twitter_feed_widget").tweet({ modpath: "./js/twitter/", avatar_size: "", count: 2, query: "themeforest", loading_text: "searching twitter...", join_text: "", template: "{join}{text}{time}" });
    }, productZoomImage: function productZoomImage() {
      {
        var b = this,
            c = a("#product-carousel");a("#product-image");
      }a.fn.elastislide && c.elastislide({ orientation: "vertical", minItems: 4 }), a.fn.elevateZoom && (a("#product-image").elevateZoom({ responsive: !0, zoomType: b.mobile || a(window).width() < 768 ? "inner" : "lens", borderColour: "#d0d0d0", cursor: "crosshair", borderSize: 2, lensSize: 180, lensOpacity: 1, lensColour: "rgba(255, 255, 255, 0.25)" }), a("#product-carousel").find("a").on("mouseover", function (b) {
        var c = a("#product-image").data("elevateZoom"),
            d = a(this).data("image"),
            e = a(this).data("zoom-image");c.swaptheimage(d, e), b.preventDefault();
      }));
    }, responsiveVideo: function responsiveVideo() {
      a.fn.fitVids && a("body").fitVids();
    }, priceSlider: function priceSlider() {
      a.fn.noUiSlider && a("#price-range").noUiSlider({ range: [0, 999], start: [0, 999], handles: 2, connect: !0, step: 1, serialization: { to: [a("#price-range-low"), a("#price-range-high")], resolution: 1 } });
    }, ratings: function ratings() {
      a.each(a(".ratings-result"), function () {
        var b = a(this),
            c = b.closest(".ratings").width(),
            d = a(this).data("result"),
            e = c / 100 * d;a(this).css("width", e);
      });
    }, collapseArrows: function collapseArrows() {
      a(".panel-title").on("click", function () {
        var b = a(this),
            c = b.find("a").attr("href");a(c).on("shown.bs.collapse", function () {
        ...
        var b = a(this),
            c = b.data("target");a(c).on("shown.bs.collapse", function () {
          b.addClass("opened");
        }).on("hidden.bs.collapse", function () {
          b.hasClass("opened") && b.removeClass("opened");
        });
      });
    }, checkSupport: function checkSupport(a, b) {
      return a.length && b ? !0 : !1;
    }, owlCarousels: function owlCarousels() {
      var b = this,
          c = a("div.brand-slider.owl-carousel");b.checkSupport(c, a.fn.owlCarousel) && c.owlCarousel({ items: 6, itemsDesktop: [1199, 5], itemsDesktopSmall: [979, 4], itemsTablet: [768, 2], itemsMobile: [479, 1], slideSpeed: 600, autoPlay: 1e4, stopOnHover: !0, navigation: !1, pagination: !1, responsive: !0, autoHeight: !0 }).data("navigationBtns", ["#brand-slider-prev", "#brand-slider-next"]);var d = a(".hot-items-slider.owl-carousel");b.checkSupport(d, a.fn.owlCarousel) && d.owlCarousel({ items: 3, itemsDesktop: [1199, 3], itemsDesktopSmall: [979, 2], itemsTablet: [768, 2], itemsMobile: [479, 1], slideSpeed: 400, autoPlay: 8e3, stopOnHover: !0, navigation: !1, pagination: !1, responsive: !0, mouseDrag: !1, autoHeight: !0 }).data("navigationBtns", ["#hot-items-slider-prev", "#hot-items-slider-next"]);var e = a(".purchased-items-slider.owl-carousel");b.checkSupport(e, a.fn.owlCarousel) && e.owlCarousel({ items: 4, itemsDesktop: [1199, 4], itemsDesktopSmall: [979, 3], itemsTablet: [768, 2], itemsMobile: [479, 1], slideSpeed: 400, autoPlay: 8e3, stopOnHover: !0, navigation: !1, pagination: !1, responsive: !0, mouseDrag: !1, autoHeight: !0 }).data("navigationBtns", ["#purchased-items-slider-prev", "#purchased-items-slider-next"]);var f = a(".similiar-items-slider.owl-carousel");b.checkSupport(f, a.fn.owlCarousel) && f.owlCarousel({ items: 4, itemsDesktop: [1199, 4], itemsDesktopSmall: [979, 3], itemsTablet: [768, 2], itemsMobile: [479, 1], slideSpeed: 400, autoPlay: 8e3, stopOnHover: !0, navigation: !1, pagination: !1, responsive: !0, mouseDrag: !1, autoHeight: !0 }).data("navigationBtns", ["#similiar-items-slider-prev", "#similiar-items-slider-next"]);var g = a(".related-portfolio.owl-carousel");b.checkSupport(g, a.fn.owlCarousel) && g.owlCarousel({ items: 4, itemsDesktop: [1199, 4], itemsDesktopSmall: [979, 3], itemsTablet: [768, 2], itemsMobile: [479, 1], slideSpeed: 400, autoPlay: 8e3, stopOnHover: !0, navigation: !1, pagination: !1, responsive: !0, mouseDrag: !1, autoHeight: !0 }).data("navigationBtns", ["#related-slider-prev", "#related-slider-next"]), b.checkSupport(a(".owl-carousel"), a.fn.owlCarousel) && a(".owl-carousel").each(function () {
        var b,
            c,
            d = a(this),
            e = d.data("owlCarousel"),
            f = d.data("navigationBtns");if ("undefined" != typeof e && "undefined" != typeof f) {
          for (var g in f) {
            -1 == f[g].indexOf("next") ? b = a(f[g]) : c = a(f[g]);
    ...
    }, flexsliders: function flexsliders() {
      a.fn.flexslider && (a(".category-image-slider.flexslider").flexslider({ animation: "slide", animationLoop: !0, prevText: "", nextText: "", controlNav: !1, smoothHeight: !0, slideshowSpeed: 6500 }), a(".latest-posts-slider.flexslider").flexslider({ animation: "slide", selector: ".latest-posts-list > li", prevText: "", nextText: "", controlNav: !1, smoothHeight: !0, slideshowSpeed: 6e3 }), a(".recent-posts-slider.flexslider").flexslider({ animation: "slide", selector: ".recent-posts-list > li", prevText: "", nextText: "", controlNav: !1, smoothHeight: !0, slideshowSpeed: 5500 }), a(".testimonials-slider.flexslider").flexslider({ animation: "fade", selector: ".testimonials-list > li", prevText: "", nextText: "", controlNav: !1, slideshowSpeed: 4800 }), a(".featured-slider.flexslider").flexslider({ animation: "slide", selector: ".featured-list > li", controlNav: !1, prevText: "", nextText: "", smoothHeight: !0, slideshowSpeed: 7e3 }), a(".related-slider.flexslider").flexslider({ animation: "slide", selector: ".related-list > li", controlNav: !1, prevText: "", nextText: "", smoothHeight: !0, slideshowSpeed: 7e3 }), a(".banner-slider.flexslider").flexslider({ animation: "fade", selector: ".banner-slider-list > li", directionNav: !1, controlNav: !0, prevText: "", nextText: "", slideshowSpeed: 6500 }), a(".about-us-testimonials.flexslider").flexslider({ animation: "slide", controlNav: !0, directionNav: !1, animationLoop: !0, smoothHeight: !0, slideshowSpeed: 6e3 }), a(".single-portfolio-slider.flexslider").flexslider({ animation: "slide", controlNav: !1, directionNav: !0, animationLoop: !0, smoothHeight: !0, slideshowSpeed: 6e3 }), a(".footer-popular-slider.flexslider").flexslider({ animation: "slide", controlNav: !1, prevText: "", nextText: "", smoothHeight: !0, slideshowSpeed: 8e3 }), a(".footer-featured-slider.flexslider").flexslider({ animation: "slide", controlNav: !1, prevText: "", nextText: "", smoothHeight: !0, slideshowSpeed: 1e4 }), a(".footer-specials-slider.flexslider").flexslider({ animation: "slide", controlNav: !1, prevText: "", nextText: "", smoothHeight: !0, slideshowSpeed: 9e3 }));
    }, scrollTopBtnAppear: function scrollTopBtnAppear() {
      var b = a(window).scrollTop(),
          c = a("#scroll-top");b >= 300 ? c.addClass("fixed") : c.removeClass("fixed");
    }, scrollTopAnimation: function scrollTopAnimation() {
      a("#scroll-top").on("click", function (b) {
        a("html, body").animate({ scrollTop: 0 }, 1200), b.preventDefault();
      });
    }, filterScrollBar: function filterScrollBar() {
      var b = a(".category-filter-list.jscrollpane"),
          c = function c(a) {
        var b = a.height();b > 300 && (a.css("height", 300), a.jScrollPane({ showArrows: !1 }));
      };a.each(b, function () {
        var b = a(this);c(b);
      }), a("#category-filter").find(".collapse").on("shown.bs.collapse", function () {
        var b = a(this).find(".category-filter-list.jscrollpane");c(b);
      });
    }, fixfilterScrollBar: function fixfilterScrollBar() {
      a(".category-filter-list.jscrollpane").each(function () {
        var b,
            c = a(this).data("jsp");b || (b = setTimeout(function () {
          c && c.reinitialise(), b = null;
        }, 50));
      });
    }, selectBox: function selectBox() {
      a.fn.selectbox && a(".selectbox").selectbox({ effect: "fade", onChange: function onChange() {} });
      ...
      a.fn.appear ? (a(".progress-animate").appear(), a(".progress-animate").on("appear", function () {
        var b = a(this),
            c = a(this).data("width"),
            d = b.find(".progress-text");b.css({ width: c + "%" }, 400), d.fadeIn(500);
      })) : a(".progress-animate").each(function () {
        var b = a(this),
            c = a(this).data("width"),
            d = b.find(".progress-text");b.css({ width: c + "%" }, 400), d.fadeIn(500);
      });
    }, scrollAnimations: function scrollAnimations() {
      "function" == typeof WOW && new WOW({ boxClass: "wow", animateClass: "animated", offset: 0 }).init();
    }, prettyPhoto: function prettyPhoto() {
      a.fn.prettyPhoto && a("a[data-rel^='prettyPhoto']").prettyPhoto({ hook: "data-rel", animation_speed: "fast", slideshow: 6e3, autoplay_slideshow: !0, show_title: !1, deeplinking: !1, social_tools: "", overlay_gallery: !0, theme: "light_square" });
    }, tabMenuHeight: function tabMenuHeight(b) {
      var c = a(".tab-container.left, .tab-container.right"),
          d = c.find(".tab-pane.active").outerHeight(),
          e = c.find(".nav-tabs");d > b ? (e.css("height", d), e.find("li:last-child").find("a").css("border-bottom-color", "#dcdcdc")) : (e.css("height", b), e.find("li:last-child").find("a").css("border-bottom-color", "transparent"));
    }, flickerFeed: function flickerFeed() {
      a.fn.jflickrfeed && a("ul.flickr-feed-list").jflickrfeed({ limit: 6, qstrings: { id: "52617155@N08" }, itemTemplate: '<li><a data-rel="prettyPhoto[gallery-flickr]" href="{{image}}" title="{{title}}"><img src="{{image_s}}" alt="{{title}}" /></a></li>' }, function () {
        a.fn.prettyPhoto && a("a[data-rel^='prettyPhoto']").prettyPhoto({ hook: "data-rel", animation_speed: "fast", slideshow: 6e3, autoplay_slideshow: !0, show_title: !1, deeplinking: !1, social_tools: "", overlay_gallery: !0, theme: "light_square" });
      });
      ...
      var b,
          ...
          e = this.container.data("maxcolumn");b = c > 1170 ? e ? e : 5 : c > 960 ? e ? e : 4 : c > 768 ? 3 : c > 540 ? 2 : 1;var f = this.container.find(".portfolio-item");b >= 4 && f.hasClass("wide") ? (this.container.find(".wide").css("width", 2 * Math.floor(d / b)), f.not(".wide").css("width", Math.floor(d / b))) : f.css("width", Math.floor(d / b));
    }, isotopeActivate: function isotopeActivate() {
      if (a.fn.isotope) {
        var b = this.container,
            c = b.data("layoutmode");b.isotope({ itemSelector: ".portfolio-item", layoutMode: c ? c : "masonry" }).data("isotope");
      }
    }, isotopeReinit: function isotopeReinit() {
      a.fn.isotope && (this.container.isotope("destroy"), this.isotopeActivate());
    }, isotopeFilter: function isotopeFilter() {
      var b = this,
          c = a("#portfolio-filter");c.find("a").on("click", function (d) {
        var e = a(this),
            f = e.attr("data-filter");c.find(".active").removeClass("active"), b.container.isotope({ filter: f }), e.addClass("active"), d.preventDefault();
      });
    ...
    var c = a(window).width(),
        ...
        e = d.find("ul.nav-tabs").outerHeight();c > 767 && (b.tabMenuHeight(e), a(".tab-container").find("ul.nav-tabs").find("a").on("shown.bs.tab", function () {
      b.tabMenuHeight(e);
    }));
  });
}(jQuery), function () {
  ...
  function a() {
    var a = new google.maps.LatLng(51.520068, -.156299),
        b = { center: a, zoom: 15, scrollwheel: !1, mapTypeId: google.maps.MapTypeId.ROADMAP, styles: [{ elementType: "geometry", stylers: [{ hue: "#000" }, { weight: 1 }, { saturation: -200 }, { gamma: .7 }, { visibility: "on" }] }] },
        c = new google.maps.Map(document.getElementById("map"), b),
        d = "images/pin.png";new google.maps.Marker({ position: a, map: c, icon: d, animation: google.maps.Animation.DROP, title: "Venedor" });
  ...
  function b(a) {
    var b,
        c = "|" + a.replace(" ", "+") + ":400,700,400italic",
        d = i.attr("href");-1 == d.indexOf(a) && (b = d + "" + c, i.attr("href", b));
  }var c = a("div#option-panel"),
      d = c.outerWidth(),
      e = c.offset().left,
      f = 0 > e ? !1 : !0;a("#option-panel-btn").on("click", function () {
    f || (c.animate({ left: 0 }, 400, function () {
      f = !0;
    }), a(this).removeClass("closed").addClass("opened"));
  }), a("#option-close").on("click", function (b) {
    f && (c.animate({ left: -d }, 400, function () {
      f = !1;
    }), a("#option-panel-btn").removeClass("opened").addClass("closed")), b.preventDefault();
  }), a('a[data-toggle="tab"]').on("shown.bs.tab", function (b) {
    var c = a(b.target).data("panel-title");a("#option-panel-title").find("span").text(c);
  });var g = a("#custom-style");if (a("#option-panel-reset").on("click", function (b) {
  ...
  }a.fn.colpick && (a("#panel-color-picker").colpick({ flat: !0, layout: "hex", submit: 0, onChange: function onChange(b, c) {
      a("body").css("background", "#" + c);
    } }).mouseup(function () {
    if (a.cookie("bgPattern") && a.removeCookie("bgPattern"), a("#wrapper").hasClass("boxed") && a.cookie("layoutMode", "boxed")) {
      var b = a("body").css("background-color");a.cookie("bgColor", b);
    } else alert("Please change layout mode to the boxed.");
  }), a(".color-box.first-color").colpick({ colorScheme: "dark", layout: "rgbhex", color: "7bae23", onSubmit: function onSubmit(b, c, d, e) {
...
;(function ($, window, undefined) {
  ...
  $.Elastislide.defaults = {
    ...
    start: 0,
    // click item callback
    onClick: function onClick(el, position, evt) {
      return false;
    },
  ...
  $.Elastislide.prototype = {
    ...
    _addTransition: function _addTransition() {
    ...
    _setItemsSize: function _setItemsSize() {
    ...
    _setWrapperSize: function _setWrapperSize() {
    ...
    _toggleControls: function _toggleControls(dir, display) {
    ...
    _slide: function _slide(dir, tvalue) {
      ...
      if (this.support) {
        ...
        this.$el.stop().applyStyle(styleCSS, $.extend(true, [], { duration: this.options.speed, complete: function complete() {
    ...
    _onEndTransition: function _onEndTransition() {

      this.isSliding = false;
      this.options.onAfterSlide();
    },
    _slideTo: function _slideTo(pos) {
    ...
    _slideToItem: function _slideToItem(pos) {
    ...
    setCurrent: function setCurrent(idx, callback) {
...
;window.Modernizr = function (a, b, c) {
  function y(a) {
    ...
    for (var d in a) {
      var e = a[d];if (!B(e, "-") && j[e] !== c) return b == "pfx" ? e : !0;
    }return !1;
  }function D(a, b, d) {
    for (var e in a) {
      var f = b[a[e]];if (f !== c) return d === !1 ? a[e] : A(f, "function") ? f.bind(d || b) : f;
    }return !1;
  }function E(a, b, c) {
    var d = a.charAt(0).toUpperCase() + a.slice(1),
        e = (a + " " + o.join(d + " ") + d).split(" ");return A(b, "string") || A(b, "undefined") ? C(e, b) : (e = (a + " " + p.join(d + " ") + d).split(" "), D(e, b, c));
  }var d = "2.7.1",
      e = {},
      f = !0,
      g = b.documentElement,
      ...
      v,
      w = {}.hasOwnProperty,
      x;!A(w, "undefined") && !A(w.call, "undefined") ? x = function x(a, b) {
    return w.call(a, b);
  } : x = function x(a, b) {
